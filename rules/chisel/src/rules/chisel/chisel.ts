/**
 * @fileoverview Use Chisel to access accessibility of web sites and web applications
 */
...
const rule: IRuleBuilder = {
    ...
    meta: {
        docs: {
            ...
            description: `Use Chisel to access accessibility of web sites and web applications`
        },
        recommended: false,
        schema: [{
